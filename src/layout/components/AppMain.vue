...
.app-main {
  margin: var(--app-main-margin) var(--app-main-margin) 0 var(--app-main-margin);
...
.show-tag-view {
  height: calc(
    100vh - #{var(--nav-bar-height)} - #{var(--tag-view-height)} - #{var(--app-main-margin)}
  ) !important;
}
